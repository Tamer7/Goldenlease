...
class GatewayCheque extends PaymentGateway {
	...
	public function __construct() {
		...
		$this->method_title = __( 'Payment on site' );
		$this->method_description = __( 'Payment can only be made on site via cash' );
	...
	public function charge( $ecommerce_cart, $request ) {
		...
		return redirect()->route('FrontendCheckoutThankYou')->with([
			'status' => 'success',
