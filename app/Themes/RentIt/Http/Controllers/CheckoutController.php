...
class CheckoutController extends RentItTheme {
	...
	
	{
		...
		$ecommerce_cart = Session::get('ecommerce_cart');
		$product = Product::find($ecommerce_cart['product_id']);
		$content = $this->getTemplate( 'checkout.thankyou', compact('product') );
	...
	public function ourDeals()
	{
		$content = $this->getTemplate( 'pages.our-deals');
